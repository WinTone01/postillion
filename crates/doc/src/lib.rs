//! postillion-doc — session & workspace Loro doc schemas and the typed mirror layer.
//!
...
//!
//! Load-bearing invariant (measured in postillion, `oplog-shape.test.ts`): message parts are a
