...
//! Usage: cargo run -p postillion-doc --example rebuild_whale -- <snapshot.bin>
use loro::LoroDoc;
use postillion_doc::rebuild::{doc_epoch, rebuild_thin_doc};
use postillion_doc::schema::SessionDoc;
