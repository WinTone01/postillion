//! Syntax-highlighting contracts shared by Postillion's desktop surfaces.
//!
...
fn rust_configuration() -> Result<HighlightConfiguration, HighlightError> {
    ...
    // `constant.builtin`. Postillion preserves those structural roles separately.
