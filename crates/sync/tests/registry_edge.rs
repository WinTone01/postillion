...
use postillion_proto::{Chat, Session, SessionStatus};
...
fn edge_url(org: &str, user: &str) -> String {
    let base = std::env::var("POSTILLION_EDGE_WS")
        .expect("set POSTILLION_EDGE_WS to the edge origin, e.g. ws://127.0.0.1:27640");
...
#[tokio::test]
#[ignore = "requires a live edge: set POSTILLION_EDGE_WS (e.g. ws://127.0.0.1:27640)"]
