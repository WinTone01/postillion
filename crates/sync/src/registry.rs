...
//! [`postillion_doc::RegistryDoc`] under a lock. Wire frames are JSON text —
...
use postillion_doc::{PendingBatch, RegistryDoc, RegistryRow, StateOutcome};
...
// ── stats (RoomStatsSnapshot-compatible so SyncStatus/`postillion sync` render it) ─
