...
/// result frame. `cargo test -p postillion-harness --test claude -- --ignored`.
#[tokio::test]
...
/// Live smoke against the real CLI: `cargo test -p postillion-harness --test
