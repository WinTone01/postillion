#!/bin/sh
# Fake ACP agent for postillion-harness tests.
#
...
has "$line" '"name":"postillion"' || exit 1
...
*scenario:prompt-complete-stale*)
  ...
  emit "{\"method\":\"_x.ai/session/prompt_complete\",\"params\":{\"sessionId\":\"other\",\"promptId\":\"postillion-p1\",\"stopReason\":\"cancelled\",\"agentResult\":null}}"
  sleep 1
...
*scenario:happy*)
  ...
  update '{"sessionUpdate":"tool_call_update","toolCallId":"t1","status":"completed","content":[{"type":"content","content":{"type":"text","text":"   Compiling postillion-harness v0.1.21\n    Finished `dev` profile [unoptimized] in 2.41s\n     Running tests/acp.rs\n\nrunning 13 tests\ntest result: ok. 13 passed; 0 failed; 0 ignored"}}]}'
