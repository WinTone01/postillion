#!/bin/sh
# Fake Claude Code CLI for postillion-harness tests.
#
...
*scenario:happy*)
  ...
  emit '{"type":"result","subtype":"success","result":"done!","errors":[],"usage":{"input_tokens":10,"output_tokens":20,"cache_creation_input_tokens":30,"cache_read_input_tokens":600},"session_id":"sess-1","total_cost_usd":0.01}'
  ;;
