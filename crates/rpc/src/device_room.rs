...
pub struct LinkCacheConfig {
    ...
    /// redialed at full cadence; callers fail fast in between (postillion peers.ts behavior).
...
impl LinkCacheConfig {
    pub fn new(edge_url: impl Into<String>, token: Arc<dyn TokenSource>) -> Self {
        ...
        // this cache: one blip must cost seconds, not minutes. The old postillion
