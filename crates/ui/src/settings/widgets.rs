...
//! (postillion settings.devices.tsx / settings.agents.tsx / settings.archived.tsx).
...
/// title + `text-[13px]` count sharing a baseline (postillion settings.devices.tsx).
...
/// Display-only toggle switch (postillion branch-picker.tsx `Toggle`): an 18×32
