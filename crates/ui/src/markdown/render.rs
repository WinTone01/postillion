...
/// Gap between markdown blocks inside one message (postillion mdBlockGap).
pub const MD_BLOCK_GAP: f32 = 12.0;
/// Body text size / line height (postillion: 14px / 22px).
...
/// Uniform cell padding in px (postillion `table.cellPadding`).
pub const TABLE_CELL_PADDING: f32 = 12.0;
/// Hairline between rows in px (postillion `table.gap`).
pub const TABLE_DIVIDER: f32 = 1.0;
/// Header row font weight (postillion `table.headerWeight` = 700).
...
/// Minimum rendered column width in px, padding included (postillion
...
/// Hairline tone (postillion md theme `table.borderColor`: rgba(255,255,255,0.1)).
...
/// Tight monochrome heading scale (postillion: h2 ≈ 16px semibold; headings step
