...
icon_assets![
    ...
    // Mirrored variant (postillion window-controls.tsx `-scale-x-100`): the LEFT
    ...
    // Hand-drawn postillion glyphs (terminal-panel.tsx / composer-actions.tsx /
    ...
    (STAR, "star"),
    (STAR_BOLD, "star-bold"),
    (POSTILLION_LOGO, "postillion-logo"),
...
/// The Claude mark's brand orange (`#D97757`) — postillion keeps it even on the
/// monochrome surface.
