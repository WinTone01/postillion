...
use postillion_harness::{Harness, HarnessError, mock::MockHarness};
use postillion_proto::{AgentEvent, DoneStatus, HarnessId, ReasoningLevel, SteeringMode};
...
/// `claude-code` slot resolved through `postillion_harness` on first use (subprocess
...
pub fn default_registry() -> HarnessRegistry {
    ...
    postillion_harness::shell_env::prewarm();
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::ClaudeHarness::new().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::ClaudeHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    // postillion_harness::codex::catalog. CLI discovery only happens when a
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::CodexHarness::new().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::CodexHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::CursorHarness::new().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::CursorHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::AcpHarness::grok().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::AcpHarness::grok()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::AcpHarness::hermes().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::AcpHarness::hermes()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::AcpHarness::pi().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::AcpHarness::pi()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| postillion_harness::AcpHarness::opencode().installed()),
        Box::new(|| Ok(Arc::new(postillion_harness::AcpHarness::opencode()) as Arc<dyn Harness>)),
    );
    registry
}
