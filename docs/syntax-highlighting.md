...
Desktop syntax highlighting lives in the pure `postillion-syntax` crate. It detects
...
5. Run `cargo test -p postillion-syntax`, UI Markdown/Changes tests, the ignored
