...
/// Provider-neutral lifecycle state from `postillion-proto`.
...
/// postillion-proto FolderListing (entities.rs:225): the device's answer to
...
/// postillion-proto RepoRef (entities.rs:193): one selectable ref from ListRefs.
...
/// postillion-proto RunRequest (agent.rs:81). `reasoning` is lowercase
