...
final class DemoDataset {
    ...
    static func standard() -> DemoDataset {
        ...
        let postillion = Space(id: "space-postillion", deviceId: "dev-mac",
                          path: "/Users/dev/postillion", name: nil, gitDetected: true,
        ...
        let chats = [
            Chat(id: "chat-veil", deviceId: "dev-mac", title: "Streaming veil on transcript rows",
                 archived: false, cwd: "/Users/dev/.postillion/worktrees/postillion-veil-fade",
            ...
            Chat(id: "chat-tabs", deviceId: "dev-mac", title: "Tool group header colors",
                 ...
                 spaceId: postillion.id, lastSeenAt: now - 3_600_000),
        ...
        let changeRequests = [
            "chat-veil": ChangeRequestSummary(
                ...
                url: "https://github.com/WinTone01/postillion/pull/90", state: .open,
                baseRef: "main", headRef: "veil-fade"
            ),
            "chat-picker": ChangeRequestSummary(
                provider: "github", number: 84, title: "Synchronize model catalogs",
                url: "https://github.com/WinTone01/postillion/pull/84", state: .merged,
                baseRef: "main", headRef: "main"
            ),
            "chat-tabs": ChangeRequestSummary(
                provider: "github", number: 77, title: "Refine tool group colors",
                url: "https://github.com/WinTone01/postillion/pull/77", state: .closed,
                baseRef: "main", headRef: "main"
            ),
        ]
        return DemoDataset(devices: [mac, vps], spaces: [postillion, edge],
    ...
    static let fileTree: [String: [String]] = [
        ...
        "/Users/dev/Projects": ["postillion", "dotfiles", "blog", "playground"],
        "/Users/dev/Projects/postillion": ["apps", "crates", "docs", "edge"],
    ...
    private static let repoNames: Set<String> = ["postillion", "dotfiles", "blog", "playground", "edge", "landing"]
    ...
    func listRefs(spacePath: String) -> [RepoRef] {
        ...
        let seeded: [RepoRef]
        if spacePath.contains("postillion") {
            seeded = [
                RepoRef(name: "main", current: true, worktreePath: nil),
                RepoRef(name: "veil-fade", current: false,
                        worktreePath: "/Users/dev/.postillion/worktrees/postillion-veil-fade"),
    ...
    func createWorktree(spacePath: String, base: String) -> String {
        ...
        let path = "/Users/dev/.postillion/worktrees/\((spacePath as NSString).lastPathComponent)-\(slug)"
        ...
        case "chat-veil":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "editFile", fields: ["path": "Postillion/Transcript/Veil.swift"]), isError: false, resolved: true),
                    .tool(id: "tool3", call: RenderToolCall(tag: "exec", fields: ["command": "xcodebuild -scheme Postillion build"]), isError: false, resolved: true),
                    .text(id: "t1", text: """
        ...
        case "chat-tabs":
            return [
                ...
                MessageEntry(id: "m2", role: .assistant, parts: [
                    ...
                    .tool(id: "tool2", call: RenderToolCall(tag: "exec", fields: ["command": "cargo test -p postillion-ui tool_group"]), isError: true, resolved: true),
