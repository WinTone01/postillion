...
Postillion bundles the following syntax-highlighting components. Their parsers and
...
The full Postillion distribution remains licensed under the terms in `LICENSE`.
